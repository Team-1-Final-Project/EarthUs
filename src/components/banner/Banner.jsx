    ...
    <>
      <Slider {...settings}>
        <div className="flex justify-center ">
          <div className="flex items-center justify-center w-full gap-10 bg-green-800 h-96 rounded-xl">
        ...
        >
          <div className="flex items-center justify-center w-full gap-10 bg-sky-300 h-96 rounded-xl">
